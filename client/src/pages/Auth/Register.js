...
export const Register = () => {
  ...
  const [verifiedPhoneNumber, setVerifiedPhoneNumber] = useState(""); // State to hold verified phone number
  const navigate = useNavigate();

  const handlePhoneVerificationSuccess = (phoneNumber) => {
    setIsPhoneVerified(true);
    setVerifiedPhoneNumber(phoneNumber); // Set the verified phone number in the state
  };
      ...
      try {
        const res = await axios.post(
          `${process.env.REACT_APP_API}/api/v1/auth/register`,
          {
            ...
            email,
            password,
            phone: verifiedPhoneNumber, // Use the verified phone number here
            answer,
            address,
            pincode,
            latitude,
      ...
      <div className="register my-2">
        {isPhoneVerified ? (
          <form className="text-center m-3" onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <input
                type="text"
                className="form-control"
                value={verifiedPhoneNumber} // Display verified phone number
          ...
          <PhoneNumberVerification
            ...
            setVerifiedPhoneNumber={setVerifiedPhoneNumber} // Pass the setVerifiedPhoneNumber function
          />
        )}
      </div>
      <div className=""></div>
